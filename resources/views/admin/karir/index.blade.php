...
@section('content')
    <div class="page-inner">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="/master-admin/karir/ubah" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group ">
                            <input type="text" value="{{ $karir->judul }}" placeholder="Masukkan judul" name="judul"
                    ...
                    <div class="form-group">
                        <label>Isi</label>
                        <div class="input-group ">
                            <textarea name="isi" id="ckeditor" value="{{ $karir->isi }}" autocomplete='off'
                                class="form-control @error('isi') is-invalid @enderror" cols="30" rows="8">{{ $karir->isi }}</textarea>
                            @error('isi')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>

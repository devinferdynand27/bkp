                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('kalender-kegiatan.destroy', $item->id) }}" method="post">
                                            @method('delete')
                                            @csrf
                                            <a class="btn btn-sm btn-warning text-white" href="/master-admin/kegiatan/edit/{{$item->id}}"><i

...
@section('content')
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Lihat  Lelang</h4>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="card-title"> Lihat Data Lelang</div>
                    </div>
                    <div class="col">
            ...
            <div class="card-body">
                <form action="{{route('lelang.update' , $lelang->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" disabled value="{{$lelang->nama}}" name="nama" required placeholder="Masukan Nama / Judul Lelang" class="form-control mb-3">
                    <label for="" class="mb-2">Harga Lelang</label>
                    <input type="text" disabled value="{{$lelang->harga}}" name="harga" required placeholder="Harga Lelang" class="form-control mb-3">
                    <label class="mb-2">Deskripsi</label>
                    <textarea  disabled name="deskripsi" required id="ckeditor" autocomplete='off' class="mb-3 form-control mb-3" cols="30" rows="8">{{$lelang->deskripsi}}</textarea><br>
                    <label for="" class="mb-2">Alamat</label>
                    <textarea  disabled id="" name="alamat" required cols="30" rows="10" placeholder="alamat" class="form-control">{{$lelang->alamat}}</textarea><br>
                    <label for="" class="mb-2">Gambar</label>
                   <br>
                        <center> <img id="uploadPreview" src="{{asset('images/lelang/' .$lelang->gambar)}}" style="width: 100%"><br> </center>
                 </div>
                </form>
                </div>
        </div>

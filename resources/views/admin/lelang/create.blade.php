...
@section('content')
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Tambah Data Lelang</h4>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="card-title"> Tambah Data Lelang</div>
                    </div>
                    <div class="col">
            ...
            <div class="card-body">
                <form action="{{route('lelang.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="nama" required placeholder="Masukan Nama / Judul Lelang" class="form-control mb-3">
                    <label for="" class="mb-2">Harga Lelang</label>
                    <input type="text" name="harga" required placeholder="Harga Lelang" class="form-control mb-3">
                    <label class="mb-2">Deskripsi</label>
                    <textarea name="deskripsi" required id="ckeditor" autocomplete='off' class="mb-3 form-control mb-3" cols="30" rows="8"></textarea><br>
                    <label for="" class="mb-2">Alamat</label>
                    <textarea  id="" name="alamat" required cols="30" rows="10" placeholder="alamat" class="form-control"></textarea><br>
                   ...
                   <div class="row">
                    <div class="col-md-10 mb-2">
                        ...
                        <center> <img id="uploadPreview" style="width: 80%"><br> </center>
                 </div>
                </form>
                </div>
        </div>

            ...
            <div class="card-body">
                <form action="{{ route('artikel.update', $artikel->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group ">
                            <select name="id_kategori_konten" required class="form-control"
                                @error('id_kategori_konten') is-invalid @enderror>
                                <option value="">-- Pilih Kategori Konten --</option>
                                @foreach ($kategoriKonten as $item)
                                    <option value="{{ $item->id }}"
                                        {{ $artikel->id_kategori_konten == $item->id ? 'selected' : '' }}>
                                        {{ $item->nama }}
                                    </option>
                                @endforeach
                            </select>
                            @error('id_kategori_konten')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group ">
                            <input type="date" value="{{ $artikel->tgl_pembuatan }}" name="tgl_pembuatan"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group ">
                            <input type="time" value="{{ $artikel->waktu_pembuatan }}" name="waktu_pembuatan"

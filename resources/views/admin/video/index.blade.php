        ...
        <div class="card">
            <div class="card-header">
                <div class="row ">
                    ...
                    <div class="col mt-3">
                        <a class="btn btn-info text-white float-right" href="/master-admin/kategori-video">
                            Kategori Video</a>
                    </div>
                    <div class="col mt-3">
                        <a class="btn btn-primary text-white float-right" href="{{ route('video.create') }}">Tambah
                            Video</a>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($video as $item)
                                <tr>
                                    ...
                                    <td data-header="Thumbnail"><a
                                            href="https://img.youtube.com/vi/{{ $item->link }}/hqdefault.jpg"
                                            data-caption="{{ $item->judul }}" data-fancybox="gallery">
                                            <img class="rouned"

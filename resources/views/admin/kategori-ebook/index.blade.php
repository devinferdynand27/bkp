...
@section('content')
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Kategori E-book</h4>
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="/master-admin/ebook">E-book</a>
                </li>
                <li class="separator">
                    <i class="fa-solid fa-chevron-right"></i>
                </li>
                <li class="nav-item">
                    <a href="">Kategori E-book</a>
                </li>
            </ul>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="card-title"> Data Kategori E-book</div>
                    </div>
                    <div class="col">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table responsive-3" id="kategoriEbook">
                        <thead>
                            <tr>
                                <th>No</th>
                                {{-- <th>Cover</th> --}}
                        ...
                        <tbody>
                            ...
                            @foreach ($kategoriEbook as $item)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('kategori-ebook.destroy', $item->id) }}" method="post">
                                            @method('delete')
                                            @csrf
                                    ...
                                    <div class="modal-dialog modal-lg border-0" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('kategori-ebook.update', $item->id) }}"
                                                    ...
                                                    <div class="form-group">
                                                        <label>Nama Kategori Ebook</label>
                                                        <div class="input-group ">
                                                            <input type="text" value="{{ $item->nama }}"
                                                                placeholder="Masukkan Nama Kategori Ebook" name="nama"
                                                                autocomplete='off'
    ...
    <div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="modalSayaLabel"
        ...
        <div class="modal-dialog modal-lg border-0" role="document">
            <div class="modal-content">
                <div class="modal-header ">
                    <h5 class="modal-title" id="modalSayaLabel">Tambah Data Kategori E-book</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('kategori-ebook.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{-- <div class="form-group">
                            <label>Cover</label>
                            <div class="custom-file mb-3">

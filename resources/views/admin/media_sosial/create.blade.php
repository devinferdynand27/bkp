    ...
    <div class="page-inner">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-sm-8">
                        <div class="card-title"> Tambah Media Sosial</div>
                    </div>
                    <div class="col">
                    </div>
                </div>
            ...
            <div class="container mt-3">
                 <form action="{{route('media-sosial.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="">Media Sosial</label>
                        <input type="text" class="form-control" name="name" placeholder="masukan media sosial">
                    </div>
                    <div class="form-group">
                        <label for="">Link Media</label>
                        <input type="text" class="form-control" name="link" placeholder="masukan link media sosial">
                    </div>
                    <div class="form-group">

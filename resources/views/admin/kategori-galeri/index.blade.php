...
@section('content')
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Kategori Galeri</h4>
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="/master-admin/galeri">Galeri</a>
                </li>
                <li class="separator">
                    <i class="fa-solid fa-chevron-right"></i>
                </li>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="card-title"> Data Kategori Galeri</div>
                    </div>
                    <div class="col">
                                    ...
                                    <div class="modal-dialog modal-lg border-0" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header ">
                                                <h5 class="modal-title" id="modalSayaLabel">Edit Data Kategori galeri</h5>
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('kategori-galeri.update', $item->id) }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group ">
                                                            <input type="text" value="{{ $item->nama }}"
                                                                placeholder="Masukkan Nama Kategori galeri" name="nama"
                                                                autocomplete='off'
    ...
    <div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="modalSayaLabel"
        ...
        <div class="modal-dialog modal-lg border-0" role="document">
            <div class="modal-content">
                <div class="modal-header ">
                    <h5 class="modal-title" id="modalSayaLabel">Tambah Data Kategori galeri</h5>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group ">
                                <input type="text" value="{{ old('nama') }}"
                                    placeholder="Masukkan Nama Kategori galeri" name="nama" autocomplete='off'

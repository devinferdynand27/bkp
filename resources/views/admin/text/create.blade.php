    ...
    <div class="page-inner">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-sm-8">
                        <div class="card-title">Tambah Data Text</div>
                    </div>
                    <div class="col">
                    </div>
                    <div class="col">
            ...
            <div class="card-body">
                 <form action="{{route('text.store')}}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="forum-group">
                        <label for=""><b>Judul</b></label>
                        <input type="text"  required name="judul" placeholder="Masukan Judul" class="form-control mt-2">
                     </div>
                     <div class="forum-group mt-2">
                        <label for=""><b>Text</b></label>
                        <textarea name="text_name" required id="ckeditor" class="form-control" cols="30" rows="10"></textarea>

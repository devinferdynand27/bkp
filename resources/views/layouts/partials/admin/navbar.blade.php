<div class="main-header">
    <!-- Logo Header -->
    <div class="logo-header" style="background: #2E4370;">
        ...
        <a href="/master-admin/dashboard" class="logo" style="margin-bottom: 12px; margin-left: 15px;">
            ...
            <h1 class="navbar-brand text-white mt-2">Admin</h2>
        </a>
    ...
    <!-- Navbar Header -->
    <nav class="navbar navbar-header navbar-expand-lg" style="background: #1e3463;">
                    ...
                    <ul class="dropdown-menu dropdown-user animated fadeIn">
                        <div class="dropdown-user-scroll scrollbar-outer">
                            ...
                            <li>
                                ...
                                <a class="dropdown-item" href="/master-admin/setting-akun">Setting Akun</a>
                            </li>
                            <li>
                                {{-- <div class="dropdown-divider"></div> --}}
                                @if (Auth::user()->id != 1)

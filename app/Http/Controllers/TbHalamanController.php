...
class TbHalamanController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.halaman.create', compact('kategoriKonten', 'kategoriKontenEbook','text'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.halaman.edit', compact('halaman','text','kategoriKonten', 'kategoriKontenEbook'));
    }
